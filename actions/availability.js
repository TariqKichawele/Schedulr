...
import { startOfDay, addDays, parseISO, isBefore, addMinutes, format } from "date-fns";
...
export async function updateAvailability(data) {
    ...
    if(!user) throw new Error('Availability not found');
...
function generateAvailableTimeSlots(startTime, endTime, duration, bookings, dateStr, timeGap) {
    const slots = [];
